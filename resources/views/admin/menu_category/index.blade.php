...
<x-app-layout>
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <a href="{{ route('menu-category.create') }}" class="btn btn-gradient-primary btn-rounded btn-fw">
                Create Category
            </a>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:pl-0">
                        <div class="flex gap-3">
                            ...
                            <a href="{{ route('menu-category.edit', $menu_category->id) }}"
                                class="rounded bg-white px-2 py-1 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Edit</a>
                            <form action="{{ route('menu-category.destroy', $menu_category->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit"
