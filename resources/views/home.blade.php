                        ...
                        <form action="">
                            <div class="booking-wrap d-flex justify-content-between align-items-center">
                                ...
                                <div class="single-select-box pt-45 mb-30">
                                    <a href="{{ route('rooms') }}" class="btn select-btn">Book Now</a>
                                </div>
            ...
            <div class="container">
                    ...
                    @foreach ($rooms as $room)
                        <div class="col-xl-4 col-lg-6 col-md-6">
                            ...
                            <div class="single-room mb-50">
                                <div class="room-img">
                                    <a href="{{ route('rooms') }}"><img src="{{ 'uploadedRooms/' . $room->image }}"
                                            alt=""></a>
                                </div>
                                <div class="room-caption" style="text-align: center">
                                    <h3><a href="{{ url('room_details', $room->id) }}">{{ $room->room_title }}</a>
                                    </h3>
                                    <div class="per-night">
                                        <span>${{ $room->price }} <span>/ per night</span></span>
                                    </div>
                                    <br>
                                    <a class="btn btn-success" href="{{ url('room_details', $room->id) }}">Room
                                        Details</a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-70">
                        <a href="{{ route('rooms') }}" class="btn view-btn1">View more <i
                        ...
                        <div class="gallery-active owl-carousel">
                            @foreach ($gallarys as $gallary)
                                <div class="gallery-img">
                                    <a href="{{ route('hotel_gallary') }}"><img src="gallary/{{ $gallary->image }}" alt=""></a>
                                </div>
                            @endforeach
                            {{-- <div class="gallery-img">
        ...
        <div class="footer-area black-bg footer-padding">
            ...
            <p style="text-align: center;">Copyright &copy;
                <script>
                    ...
                    aria-hidden="true"></i> by <a target="_blank">Akila Kodithuwakku</a>
            </p>
